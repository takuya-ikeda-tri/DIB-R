...
# https://buaiso.blogspot.com/2015/07/blog-post.html?m=0
...
# def compute_camera_params_torch(azimuth, elevation, distance, device='cpu'):
#     theta = azimuth * np.pi / 180.0
#     phi = elevation * np.pi / 180.0
...
class Renderer(nn.Module):
    ...
    def forward(self, points, camera_params, *args, **kwargs):
        if camera_params is None:
            ...
            camera_params = self.set_look_at_parameters([0], [30], [1])
